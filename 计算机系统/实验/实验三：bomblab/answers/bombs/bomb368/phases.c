 ...
 */
listNode node6 = {544, 6, NULL};
listNode node5 = {973, 5, &node6};
listNode node4 = {483, 4, &node5};
listNode node3 = {385, 3, &node4};
listNode node2 = {758, 2, &node3};
listNode node1 = {239, 1, &node2};
