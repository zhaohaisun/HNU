 ...
 * order.
 */
listNode node6 = {464, 6, NULL};
listNode node5 = {99, 5, &node6};
listNode node4 = {471, 4, &node5};
listNode node3 = {120, 3, &node4};
listNode node2 = {473, 2, &node3};
listNode node1 = {258, 1, &node2};
