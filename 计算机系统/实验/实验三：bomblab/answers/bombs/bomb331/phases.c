 ...
 */
listNode node6 = {98, 6, NULL};
listNode node5 = {572, 5, &node6};
listNode node4 = {560, 4, &node5};
listNode node3 = {466, 3, &node4};
listNode node2 = {743, 2, &node3};
listNode node1 = {738, 1, &node2};
