 ...
 */
listNode node6 = {102, 6, NULL};
listNode node5 = {808, 5, &node6};
listNode node4 = {322, 4, &node5};
listNode node3 = {569, 3, &node4};
listNode node2 = {731, 2, &node3};
listNode node1 = {612, 1, &node2};
