 ...
 * order.
 */
listNode node6 = {724, 6, NULL};
listNode node5 = {804, 5, &node6};
listNode node4 = {549, 4, &node5};
listNode node3 = {481, 3, &node4};
listNode node2 = {950, 2, &node3};
listNode node1 = {396, 1, &node2};
