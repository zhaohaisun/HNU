 ...
 */
listNode node6 = {557, 6, NULL};
listNode node5 = {812, 5, &node6};
listNode node4 = {301, 4, &node5};
listNode node3 = {244, 3, &node4};
listNode node2 = {257, 2, &node3};
listNode node1 = {544, 1, &node2};
