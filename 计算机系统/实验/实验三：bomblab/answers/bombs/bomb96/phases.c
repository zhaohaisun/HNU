 ...
 */
listNode node6 = {665, 6, NULL};
listNode node5 = {478, 5, &node6};
listNode node4 = {498, 4, &node5};
listNode node3 = {782, 3, &node4};
listNode node2 = {333, 2, &node3};
listNode node1 = {255, 1, &node2};
