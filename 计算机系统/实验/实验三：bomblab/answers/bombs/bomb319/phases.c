 ...
 */
listNode node6 = {496, 6, NULL};
listNode node5 = {289, 5, &node6};
listNode node4 = {479, 4, &node5};
listNode node3 = {973, 3, &node4};
listNode node2 = {980, 2, &node3};
listNode node1 = {837, 1, &node2};
