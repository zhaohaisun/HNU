 ...
 */
listNode node6 = {578, 6, NULL};
listNode node5 = {637, 5, &node6};
listNode node4 = {804, 4, &node5};
listNode node3 = {805, 3, &node4};
listNode node2 = {63, 2, &node3};
listNode node1 = {885, 1, &node2};
