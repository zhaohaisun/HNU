 ...
 */
listNode node6 = {620, 6, NULL};
listNode node5 = {956, 5, &node6};
listNode node4 = {393, 4, &node5};
listNode node3 = {106, 3, &node4};
listNode node2 = {420, 2, &node3};
listNode node1 = {891, 1, &node2};
