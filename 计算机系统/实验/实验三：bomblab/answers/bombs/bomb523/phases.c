 ...
 */
listNode node6 = {734, 6, NULL};
listNode node5 = {549, 5, &node6};
listNode node4 = {458, 4, &node5};
listNode node3 = {657, 3, &node4};
listNode node2 = {726, 2, &node3};
listNode node1 = {618, 1, &node2};
