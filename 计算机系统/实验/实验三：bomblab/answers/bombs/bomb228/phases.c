 ...
 */
listNode node6 = {149, 6, NULL};
listNode node5 = {263, 5, &node6};
listNode node4 = {293, 4, &node5};
listNode node3 = {371, 3, &node4};
listNode node2 = {251, 2, &node3};
listNode node1 = {63, 1, &node2};
