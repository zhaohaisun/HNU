 ...
 */
listNode node6 = {704, 6, NULL};
listNode node5 = {984, 5, &node6};
listNode node4 = {936, 4, &node5};
listNode node3 = {136, 3, &node4};
listNode node2 = {192, 2, &node3};
listNode node1 = {534, 1, &node2};
