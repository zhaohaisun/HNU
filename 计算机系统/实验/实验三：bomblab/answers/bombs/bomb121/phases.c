 ...
 * order.
 */
listNode node6 = {322, 6, NULL};
listNode node5 = {352, 5, &node6};
listNode node4 = {456, 4, &node5};
listNode node3 = {555, 3, &node4};
listNode node2 = {882, 2, &node3};
listNode node1 = {450, 1, &node2};
