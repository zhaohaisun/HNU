 ...
 */
listNode node6 = {770, 6, NULL};
listNode node5 = {702, 5, &node6};
listNode node4 = {749, 4, &node5};
listNode node3 = {759, 3, &node4};
listNode node2 = {933, 2, &node3};
listNode node1 = {741, 1, &node2};
