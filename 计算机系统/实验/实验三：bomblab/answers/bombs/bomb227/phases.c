 ...
 */
listNode node6 = {549, 6, NULL};
listNode node5 = {756, 5, &node6};
listNode node4 = {319, 4, &node5};
listNode node3 = {459, 3, &node4};
listNode node2 = {706, 2, &node3};
listNode node1 = {788, 1, &node2};
