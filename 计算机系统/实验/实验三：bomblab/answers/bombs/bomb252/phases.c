 ...
 * order.
 */
listNode node6 = {170, 6, NULL};
listNode node5 = {669, 5, &node6};
listNode node4 = {86, 4, &node5};
listNode node3 = {205, 3, &node4};
listNode node2 = {424, 2, &node3};
listNode node1 = {148, 1, &node2};
