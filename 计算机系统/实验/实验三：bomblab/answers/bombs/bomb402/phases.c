 ...
 */
listNode node6 = {168, 6, NULL};
listNode node5 = {646, 5, &node6};
listNode node4 = {468, 4, &node5};
listNode node3 = {989, 3, &node4};
listNode node2 = {196, 2, &node3};
listNode node1 = {575, 1, &node2};
