 ...
 */
listNode node6 = {978, 6, NULL};
listNode node5 = {733, 5, &node6};
listNode node4 = {798, 4, &node5};
listNode node3 = {892, 3, &node4};
listNode node2 = {265, 2, &node3};
listNode node1 = {923, 1, &node2};
