...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "I am for medical liability at the federal level.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("I am for medical liability at the federal level.\n");
#else
    invalid_phase("1c");
#endif
}
 ...
 */
listNode node6 = {192, 6, NULL};
listNode node5 = {283, 5, &node6};
listNode node4 = {556, 4, &node5};
listNode node3 = {656, 3, &node4};
listNode node2 = {390, 2, &node3};
listNode node1 = {420, 1, &node2};
