 ...
 * order.
 */
listNode node6 = {604, 6, NULL};
listNode node5 = {135, 5, &node6};
listNode node4 = {807, 4, &node5};
listNode node3 = {351, 3, &node4};
listNode node2 = {262, 2, &node3};
listNode node1 = {899, 1, &node2};
