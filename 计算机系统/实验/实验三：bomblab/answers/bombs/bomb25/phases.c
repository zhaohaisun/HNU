 ...
 * order.
 */
listNode node6 = {713, 6, NULL};
listNode node5 = {815, 5, &node6};
listNode node4 = {239, 4, &node5};
listNode node3 = {505, 3, &node4};
listNode node2 = {737, 2, &node3};
listNode node1 = {941, 1, &node2};
