 ...
 * order.
 */
listNode node6 = {121, 6, NULL};
listNode node5 = {833, 5, &node6};
listNode node4 = {435, 4, &node5};
listNode node3 = {938, 3, &node4};
listNode node2 = {544, 2, &node3};
listNode node1 = {365, 1, &node2};
