 ...
 */
listNode node6 = {758, 6, NULL};
listNode node5 = {736, 5, &node6};
listNode node4 = {175, 4, &node5};
listNode node3 = {111, 3, &node4};
listNode node2 = {204, 2, &node3};
listNode node1 = {567, 1, &node2};
