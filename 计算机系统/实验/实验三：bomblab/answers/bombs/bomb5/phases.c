 ...
 * order.
 */
listNode node6 = {946, 6, NULL};
listNode node5 = {881, 5, &node6};
listNode node4 = {800, 4, &node5};
listNode node3 = {834, 3, &node4};
listNode node2 = {800, 2, &node3};
listNode node1 = {85, 1, &node2};
