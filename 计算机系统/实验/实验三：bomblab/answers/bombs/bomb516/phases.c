 ...
 * order.
 */
listNode node6 = {446, 6, NULL};
listNode node5 = {84, 5, &node6};
listNode node4 = {595, 4, &node5};
listNode node3 = {820, 3, &node4};
listNode node2 = {466, 2, &node3};
listNode node1 = {793, 1, &node2};
