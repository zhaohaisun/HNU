 ...
 */
listNode node6 = {99, 6, NULL};
listNode node5 = {230, 5, &node6};
listNode node4 = {174, 4, &node5};
listNode node3 = {563, 3, &node4};
listNode node2 = {778, 2, &node3};
listNode node1 = {50, 1, &node2};
