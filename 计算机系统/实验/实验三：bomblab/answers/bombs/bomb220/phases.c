 ...
 * order.
 */
listNode node6 = {802, 6, NULL};
listNode node5 = {629, 5, &node6};
listNode node4 = {429, 4, &node5};
listNode node3 = {445, 3, &node4};
listNode node2 = {169, 2, &node3};
listNode node1 = {83, 1, &node2};
