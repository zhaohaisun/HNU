 ...
 */
listNode node6 = {161, 6, NULL};
listNode node5 = {459, 5, &node6};
listNode node4 = {551, 4, &node5};
listNode node3 = {899, 3, &node4};
listNode node2 = {173, 2, &node3};
listNode node1 = {811, 1, &node2};
