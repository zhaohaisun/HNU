 ...
 * order.
 */
listNode node6 = {75, 6, NULL};
listNode node5 = {840, 5, &node6};
listNode node4 = {872, 4, &node5};
listNode node3 = {88, 3, &node4};
listNode node2 = {78, 2, &node3};
listNode node1 = {368, 1, &node2};
