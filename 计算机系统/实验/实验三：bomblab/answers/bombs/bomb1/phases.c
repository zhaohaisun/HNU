 ...
 * order.
 */
listNode node6 = {260, 6, NULL};
listNode node5 = {991, 5, &node6};
listNode node4 = {412, 4, &node5};
listNode node3 = {829, 3, &node4};
listNode node2 = {287, 2, &node3};
listNode node1 = {267, 1, &node2};
