 ...
 */
listNode node6 = {72, 6, NULL};
listNode node5 = {619, 5, &node6};
listNode node4 = {906, 4, &node5};
listNode node3 = {535, 3, &node4};
listNode node2 = {949, 2, &node3};
listNode node1 = {672, 1, &node2};
