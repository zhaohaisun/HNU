...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "You can Russia from land here in Alaska.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("You can Russia from land here in Alaska.\n"); 
#else
    invalid_phase("1a");
#endif    
}
 ...
 */
listNode node6 = {510, 6, NULL};
listNode node5 = {473, 5, &node6};
listNode node4 = {619, 4, &node5};
listNode node3 = {109, 3, &node4};
listNode node2 = {104, 2, &node3};
listNode node1 = {558, 1, &node2};
