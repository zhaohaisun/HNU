 ...
 */
listNode node6 = {788, 6, NULL};
listNode node5 = {197, 5, &node6};
listNode node4 = {460, 4, &node5};
listNode node3 = {936, 3, &node4};
listNode node2 = {520, 2, &node3};
listNode node1 = {857, 1, &node2};
