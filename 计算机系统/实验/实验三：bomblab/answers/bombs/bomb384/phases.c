 ...
 */
listNode node6 = {668, 6, NULL};
listNode node5 = {565, 5, &node6};
listNode node4 = {859, 4, &node5};
listNode node3 = {905, 3, &node4};
listNode node2 = {664, 2, &node3};
listNode node1 = {917, 1, &node2};
