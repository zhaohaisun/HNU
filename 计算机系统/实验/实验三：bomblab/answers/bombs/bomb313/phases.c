 ...
 */
listNode node6 = {662, 6, NULL};
listNode node5 = {607, 5, &node6};
listNode node4 = {378, 4, &node5};
listNode node3 = {83, 3, &node4};
listNode node2 = {700, 2, &node3};
listNode node1 = {221, 1, &node2};
