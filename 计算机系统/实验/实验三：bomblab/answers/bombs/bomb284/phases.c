 ...
 */
listNode node6 = {402, 6, NULL};
listNode node5 = {381, 5, &node6};
listNode node4 = {558, 4, &node5};
listNode node3 = {852, 3, &node4};
listNode node2 = {110, 2, &node3};
listNode node1 = {286, 1, &node2};
