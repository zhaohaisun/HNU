 ...
 */
listNode node6 = {985, 6, NULL};
listNode node5 = {892, 5, &node6};
listNode node4 = {758, 4, &node5};
listNode node3 = {329, 3, &node4};
listNode node2 = {93, 2, &node3};
listNode node1 = {735, 1, &node2};
