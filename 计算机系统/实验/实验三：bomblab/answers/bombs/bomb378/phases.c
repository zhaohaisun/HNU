 ...
 */
listNode node6 = {682, 6, NULL};
listNode node5 = {428, 5, &node6};
listNode node4 = {750, 4, &node5};
listNode node3 = {324, 3, &node4};
listNode node2 = {646, 2, &node3};
listNode node1 = {952, 1, &node2};
