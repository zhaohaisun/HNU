 ...
 * order.
 */
listNode node6 = {980, 6, NULL};
listNode node5 = {566, 5, &node6};
listNode node4 = {620, 4, &node5};
listNode node3 = {410, 3, &node4};
listNode node2 = {896, 2, &node3};
listNode node1 = {685, 1, &node2};
