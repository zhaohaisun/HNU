 ...
 */
listNode node6 = {882, 6, NULL};
listNode node5 = {577, 5, &node6};
listNode node4 = {385, 4, &node5};
listNode node3 = {634, 3, &node4};
listNode node2 = {742, 2, &node3};
listNode node1 = {764, 1, &node2};
