 ...
 * order.
 */
listNode node6 = {891, 6, NULL};
listNode node5 = {237, 5, &node6};
listNode node4 = {715, 4, &node5};
listNode node3 = {77, 3, &node4};
listNode node2 = {821, 2, &node3};
listNode node1 = {794, 1, &node2};
