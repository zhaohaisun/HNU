 ...
 * order.
 */
listNode node6 = {554, 6, NULL};
listNode node5 = {343, 5, &node6};
listNode node4 = {198, 4, &node5};
listNode node3 = {619, 3, &node4};
listNode node2 = {141, 2, &node3};
listNode node1 = {387, 1, &node2};
