 ...
 */
listNode node6 = {183, 6, NULL};
listNode node5 = {838, 5, &node6};
listNode node4 = {783, 4, &node5};
listNode node3 = {344, 3, &node4};
listNode node2 = {469, 2, &node3};
listNode node1 = {902, 1, &node2};
