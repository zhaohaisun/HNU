 ...
 * order.
 */
listNode node6 = {922, 6, NULL};
listNode node5 = {982, 5, &node6};
listNode node4 = {409, 4, &node5};
listNode node3 = {559, 3, &node4};
listNode node2 = {370, 2, &node3};
listNode node1 = {732, 1, &node2};
