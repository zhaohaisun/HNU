 ...
 * order.
 */
listNode node6 = {83, 6, NULL};
listNode node5 = {349, 5, &node6};
listNode node4 = {134, 4, &node5};
listNode node3 = {626, 3, &node4};
listNode node2 = {256, 2, &node3};
listNode node1 = {156, 1, &node2};
