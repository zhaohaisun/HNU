 ...
 */
listNode node6 = {298, 6, NULL};
listNode node5 = {146, 5, &node6};
listNode node4 = {894, 4, &node5};
listNode node3 = {941, 3, &node4};
listNode node2 = {576, 2, &node3};
listNode node1 = {235, 1, &node2};
