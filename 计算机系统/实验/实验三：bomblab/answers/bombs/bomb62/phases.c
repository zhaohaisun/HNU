 ...
 * order.
 */
listNode node6 = {728, 6, NULL};
listNode node5 = {947, 5, &node6};
listNode node4 = {129, 4, &node5};
listNode node3 = {383, 3, &node4};
listNode node2 = {748, 2, &node3};
