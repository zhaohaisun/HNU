 ...
 */
listNode node6 = {480, 6, NULL};
listNode node5 = {435, 5, &node6};
listNode node4 = {529, 4, &node5};
listNode node3 = {648, 3, &node4};
listNode node2 = {58, 2, &node3};
listNode node1 = {920, 1, &node2};
