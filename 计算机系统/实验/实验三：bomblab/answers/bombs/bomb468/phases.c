 ...
 */
listNode node6 = {68, 6, NULL};
listNode node5 = {787, 5, &node6};
listNode node4 = {104, 4, &node5};
listNode node3 = {246, 3, &node4};
listNode node2 = {60, 2, &node3};
listNode node1 = {615, 1, &node2};
