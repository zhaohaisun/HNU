 ...
 */
listNode node6 = {546, 6, NULL};
listNode node5 = {977, 5, &node6};
listNode node4 = {975, 4, &node5};
listNode node3 = {953, 3, &node4};
listNode node2 = {627, 2, &node3};
listNode node1 = {889, 1, &node2};
