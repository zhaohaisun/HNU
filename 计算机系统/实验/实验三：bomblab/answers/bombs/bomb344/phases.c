 ...
 */
listNode node6 = {95, 6, NULL};
listNode node5 = {995, 5, &node6};
listNode node4 = {786, 4, &node5};
listNode node3 = {620, 3, &node4};
listNode node2 = {453, 2, &node3};
listNode node1 = {963, 1, &node2};
