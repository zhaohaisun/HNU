 ...
 * order.
 */
listNode node6 = {300, 6, NULL};
listNode node5 = {438, 5, &node6};
listNode node4 = {434, 4, &node5};
listNode node3 = {461, 3, &node4};
listNode node2 = {709, 2, &node3};
listNode node1 = {123, 1, &node2};
