...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "Public speaking is very easy.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("Public speaking is very easy.\n");
#else
    invalid_phase("1b");
#endif
}
 ...
 * order.
 */
listNode node6 = {996, 6, NULL};
listNode node5 = {503, 5, &node6};
listNode node4 = {739, 4, &node5};
listNode node3 = {177, 3, &node4};
listNode node2 = {515, 2, &node3};
listNode node1 = {959, 1, &node2};
