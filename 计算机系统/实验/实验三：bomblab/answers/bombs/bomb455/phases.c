 ...
 */
listNode node6 = {277, 6, NULL};
listNode node5 = {105, 5, &node6};
listNode node4 = {847, 4, &node5};
listNode node3 = {460, 3, &node4};
listNode node2 = {278, 2, &node3};
listNode node1 = {823, 1, &node2};
