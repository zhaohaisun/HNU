 ...
 */
listNode node6 = {532, 6, NULL};
listNode node5 = {506, 5, &node6};
listNode node4 = {317, 4, &node5};
listNode node3 = {785, 3, &node4};
listNode node2 = {559, 2, &node3};
listNode node1 = {482, 1, &node2};
