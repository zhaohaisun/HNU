 ...
 */
listNode node6 = {484, 6, NULL};
listNode node5 = {469, 5, &node6};
listNode node4 = {718, 4, &node5};
listNode node3 = {972, 3, &node4};
listNode node2 = {552, 2, &node3};
listNode node1 = {175, 1, &node2};
