 ...
 */
listNode node6 = {348, 6, NULL};
listNode node5 = {411, 5, &node6};
listNode node4 = {942, 4, &node5};
listNode node3 = {865, 3, &node4};
listNode node2 = {847, 2, &node3};
listNode node1 = {442, 1, &node2};
