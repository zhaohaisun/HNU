 ...
 */
listNode node6 = {367, 6, NULL};
listNode node5 = {117, 5, &node6};
listNode node4 = {334, 4, &node5};
listNode node3 = {957, 3, &node4};
listNode node2 = {88, 2, &node3};
listNode node1 = {665, 1, &node2};
