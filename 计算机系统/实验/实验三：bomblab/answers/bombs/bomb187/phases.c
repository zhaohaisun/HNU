 ...
 * order.
 */
listNode node6 = {583, 6, NULL};
listNode node5 = {625, 5, &node6};
listNode node4 = {701, 4, &node5};
listNode node3 = {665, 3, &node4};
listNode node2 = {764, 2, &node3};
listNode node1 = {92, 1, &node2};
