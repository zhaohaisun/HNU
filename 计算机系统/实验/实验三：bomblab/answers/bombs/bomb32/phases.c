 ...
 * order.
 */
listNode node6 = {849, 6, NULL};
listNode node5 = {383, 5, &node6};
listNode node4 = {162, 4, &node5};
listNode node3 = {403, 3, &node4};
listNode node2 = {710, 2, &node3};
listNode node1 = {768, 1, &node2};
