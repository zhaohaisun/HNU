 ...
 * order.
 */
listNode node6 = {827, 6, NULL};
listNode node5 = {694, 5, &node6};
listNode node4 = {82, 4, &node5};
listNode node3 = {144, 3, &node4};
listNode node2 = {224, 2, &node3};
listNode node1 = {703, 1, &node2};
