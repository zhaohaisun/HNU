 ...
 */
listNode node6 = {676, 6, NULL};
listNode node5 = {136, 5, &node6};
listNode node4 = {598, 4, &node5};
listNode node3 = {992, 3, &node4};
listNode node2 = {272, 2, &node3};
listNode node1 = {846, 1, &node2};
