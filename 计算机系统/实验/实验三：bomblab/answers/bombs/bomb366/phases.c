 ...
 */
listNode node6 = {840, 6, NULL};
listNode node5 = {358, 5, &node6};
listNode node4 = {83, 4, &node5};
listNode node3 = {530, 3, &node4};
listNode node2 = {380, 2, &node3};
listNode node1 = {111, 1, &node2};
