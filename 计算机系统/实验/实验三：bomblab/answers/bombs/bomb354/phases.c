 ...
 * order.
 */
listNode node6 = {927, 6, NULL};
listNode node5 = {312, 5, &node6};
listNode node4 = {796, 4, &node5};
listNode node3 = {112, 3, &node4};
listNode node2 = {353, 2, &node3};
listNode node1 = {479, 1, &node2};
