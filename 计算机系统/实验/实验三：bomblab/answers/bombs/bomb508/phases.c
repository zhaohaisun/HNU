 ...
 * order.
 */
listNode node6 = {760, 6, NULL};
listNode node5 = {836, 5, &node6};
listNode node4 = {244, 4, &node5};
listNode node3 = {137, 3, &node4};
listNode node2 = {133, 2, &node3};
listNode node1 = {658, 1, &node2};
